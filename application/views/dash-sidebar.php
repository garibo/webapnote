			...
			<div class="row">
				<div class="large-10 column">
					<ul class="side-nav">
						...
						<li <?php evalActive('notificaciones'); ?>><a href="<?=base_url('notificaciones');?>" id="not"><i class="icon-stack3 icon-menu-nav"></i>Notificaciones <!-- <span class="box-notification">23</span>--></a></li>
						<br />
